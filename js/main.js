function start() {
    ...
    musica.addEventListener("ended", 
        function(){ musica.currentTime = 0; musica.play(); }, false);
    musica.play();

    jogo.pressionou = [];

    // Verificar se houver interação do Usúario
...
function explosao1(inimigo1X,inimigo1Y) {
	...
	$("#explosao1").css("background-image", "url(img/explosao.png)");
	    ...
	    var div=$("#explosao1");  // Variavel resevada para div explosao1
        
        div.css("top", inimigo1Y);
        div.css("left", inimigo1X);
        div.animate({width:200, opacity:0}, "slow"); // animate - função Jquery
...
function gameOver() {
    ...
    $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + 
                    "<div id='reinicia' onClick=reiniciaJogo()> <h3>Jogar Novamente </Jogar></h3>  </div>");
}
